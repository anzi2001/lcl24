<template>
	<div>
	<picture>
		<source class="background-image" srcset="/images/quotesBack.webp" type="image/webp">
	...
	<div class="pure-g">
		...
		<div id="mainSlide" class="pure-u-1 pure-u-md-12-24">
			...
			<div class="pure-g">
				...
				<div class="pure-u-1 pure-u-lg-1-2 regInfo">
					...
					<div class="pure-g flex-center">
						<button type="submit" class="importButton fill submit">SIGN UP</button>
					</div>
					</form>
				</div>
				<div class="pure-u-1-4"></div>
